"""
Telegram Peer Pydantic Schemas
"""
...
class BaseTelegramChannel(BaseModel):
...
class TelegramChannel(BaseTelegramChannel):
    id: int
...
class TelegramChannelUpdate(BaseTelegramChannel):
    pass

class TelegramChannelCreate(BaseTelegramChannel):
    pass
